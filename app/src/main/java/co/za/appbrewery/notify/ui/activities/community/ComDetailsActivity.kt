...
class ComDetailsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val btnScreen = findViewById<ImageButton>(R.id.btnScreenShot)
        val mainScreen = findViewById<ConstraintLayout>(R.id.mainScreen)
    ...
    private fun shareAlert () {
        val sendIntent: Intent = Intent().apply {
            ...
            val title ="Traffic on N1"
            val desc= "Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore"
            val shareDetails ="$title, $desc"
